...
const routes: Routes = [
  ...
  { path: 'institutionfaculty', component: InstitutionFacultyInfoComponent },
  ...
  { path: 'fieldauditreport', component: FieldAuditScheduleReportComponent },
  { path: 'fieldauditguidelinereport', component: FieldAuditGuidelinesDRComponent },
  { path: 'gradingpolicyreport', component: GradingPolicyComponent },
  { path: 'infrastructurereport', component: InfrastructureComponent },
  { path: 'programmonitorreport', component: ProgramMonitoringProcessReportComponent },
  ...
  { path: 'coursemonitorreport', component: CourseMonitoringProcessReportComponent },
  { path: 'courseregistrationreport', component: CourseRegistrationReportComponent },
  { path: 'coursedescriptionreport', component: CourseDescriptionReportComponent },
  { path: 'curriculumreport', component: CurriculumRelatedInformationComponent },
];
